...
export default function ArchitectureSection({ project }: { project: any }) {
  const modules: string[] = project.architectureModules?.length
    ? project.architectureModules
    : DEFAULT_MODULES;
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6">
      ...
      <div className="mt-4 rounded-sm border border-white/8 bg-[#32353D]/40 p-6">
        <div className="h-56 w-full rounded-sm bg-[#24272b] flex items-center justify-center text-muted-foreground">
